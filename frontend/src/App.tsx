...
type DashboardPage = 'overview' | 'heat-tracking' | 'production-flow' | 'system-map' | 'access-control'

const dashboardPages: DashboardPage[] = ['overview', 'heat-tracking', 'production-flow', 'system-map', 'access-control']
