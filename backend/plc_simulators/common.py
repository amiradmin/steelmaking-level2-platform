...
async def run_plc_simulator(
    *,
    ...
    The simulator intentionally models PLC-like scan behavior and diagnostics while
    exposing the values through OPC UA for integration tests. It is not a bit-exact
    Siemens CPU emulator and does not reproduce proprietary STEP 7 execution.
    """
    ...
    diagnostics: dict[str, Any] = {
        f"{controller_prefix}.PLC.CpuModeCode": 2,
        f"{controller_prefix}.PLC.CpuMode": "RUN",
