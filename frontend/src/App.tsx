...
type DashboardPage = 'overview' | 'heat-tracking' | 'eaf' | 'production-flow' | 'system-map' | 'access-control'

const dashboardPages: DashboardPage[] = ['overview', 'heat-tracking', 'eaf', 'production-flow', 'system-map', 'access-control']
...
function Dashboard({ theme, onThemeChange, onLogout, initialOperator }: { theme: Theme; onThemeChange: () => void; onLogout: () => void; initialOperator: OperatorProfile | null }) {
  ...
  return (
    <div className="dashboard-shell">
      ...
      {dashboardPage === 'overview' && hasPermission('overview.view') && <OverviewLiveOverlay />}
